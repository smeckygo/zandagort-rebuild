...
As Zandagort is an economic based game so let’s start with some building stuff. First enter to the profile of your planet by clicking on its name in the planet list. There are several tabs on the planet profile page (such as Ecosystem, Economics, War etc.), first you will need only the economics tab.
