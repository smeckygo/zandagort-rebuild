...
$zanda_db_host = 'localhost';
$zanda_db_name='zandagort';//név, ehhez jön automatikusan a _nemlog szuffix bizonyos esetekben
$zanda_db_user='root';//usernév
$zanda_db_password='';//jelszó
...
$gs = new DatabaseConnection($zanda_db_host, $database_mmog, $zanda_db_user, $zanda_db_password);
$ls = new DatabaseConnection($zanda_db_host, $database_mmog_nemlog, $zanda_db_user, $zanda_db_password);
