...
<tr><td><b>Nick Név*</b>:</td><td><input type="text" class="szoveg" name="reg_nev" value="<?=$Account->userName;?>" size="30" /></td></tr>
<tr><td><b>Email</b>:</td><td><input type="text" class="szoveg" name="reg_email_1" value="" size="30" /></td></tr>
<tr><td><b>Jelszó**</b>:</td><td><input type="password" class="szoveg" name="reg_jelszo_1" value="" size="30" /></td></tr>
<tr><td><b>Jelszó Ismét</b>:</td><td><input type="password" class="szoveg" name="reg_jelszo_2" value="" size="30" /></td></tr>
</table>
...
<p class="regi">
<input type="radio" name="reg_pozi_valaszto" id="reg_pozi_valaszto_input_1" value="1"<? if (isset($_REQUEST['reg_pozi_valaszto'])!=2) echo ' checked="checked"'; ?> onclick="pozi_valaszto_fv(1)" /><label for="reg_pozi_valaszto_input_1"> <?=$lang[$lang_lang]['index_kulso.php']['Legyen meglepetés.'];?></label>
<input type="radio" name="reg_pozi_valaszto" id="reg_pozi_valaszto_input_2" value="2"<? if (isset($_REQUEST['reg_pozi_valaszto'])==2) echo ' checked="checked"'; ?> onclick="pozi_valaszto_fv(2)" /><label for="reg_pozi_valaszto_input_2"> <?=$lang[$lang_lang]['index_kulso.php']['Megadom a koordinátákat.'];?></label>
</p>
<div id="pozi_valaszto_div_1"<? if (isset($_REQUEST['reg_pozi_valaszto'])==2) echo ' style="display:none"';?>></div>
<div id="pozi_valaszto_div_2"<? if (isset($_REQUEST['reg_pozi_valaszto'])!=2) echo ' style="display:none"';?>>
...
<p class="regi"><input type="text" class="szoveg" id="reg_koord" name="reg_koord" value="" /><br /><?=$lang[$lang_lang]['index_kulso.php']['(É xxx, Ny xxx formátumban)'];?></p>
